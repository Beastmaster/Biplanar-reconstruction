...
//----------------------------------------------------------------------------
void interactor_style::OnLeftButtonDown()
{
...
//----------------------------------------------------------------------------
void interactor_style::OnMiddleButtonDown()
{
	this->FindPokedRenderer(this->Interactor->GetEventPosition()[0],
		this->Interactor->GetEventPosition()[1]);
	if (this->CurrentRenderer == NULL)
...
//----------------------------------------------------------------------------
void interactor_style::OnMiddleButtonUp()
{
	switch (this->State)
	{
	case VTKIS_PAN:
...
//----------------------------------------------------------------------------
void interactor_style::OnRightButtonUp()
{
	switch (this->State)
	{
	case VTKIS_DOLLY:
...
//----------------------------------------------------------------------------
void interactor_style::Dolly(double factor)
{
	if (this->CurrentRenderer == NULL)
	{
		return;
...
//----------------------------------------------------------------------------
void interactor_style::PrintSelf(ostream& os, vtkIndent indent)
{
