...
// .SECTION Description
// The vtkSeedWidgetx is used to placed multiple seed points in the scene.
// The seed points can be used for operations like connectivity, segmentation,
// and region growing.
//
// To use this widget, specify an instance of vtkSeedWidgetx and a
...
// into the vtkSeedWidgetx's widget events:
// <pre>
...
//   vtkCommand::DeleteEvent (after last point removed )
// </pre>
...
#ifndef vtkSeedWidgetx_h
#define vtkSeedWidgetx_h
